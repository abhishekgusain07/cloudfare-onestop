...
import { uploadAudioBufferToCloudinary } from '@/lib/cloudinary/utils';

// Check if API key is available
const apiKey = env.ELEVEN_LABS_API_KEY;
if (!apiKey) {
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const cloudinaryResponse = await uploadAudioBufferToCloudinary(audioBuffer, {
            resource_type: 'auto',
