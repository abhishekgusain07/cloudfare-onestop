        ...
        <div>
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex-1 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg px-4 py-3 text-center transition-colors"
            >
        ...
        <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-3">
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm">
              <div className="font-medium text-blue-400 mb-1">Music Tips</div>
